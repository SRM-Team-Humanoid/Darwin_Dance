...
motion1 = MotionSet(tree3.parsexml("Motion1"))
...
if __name__=='__main__':
    ...
    #bwalk_init.execute(iter=1,speed=1.1)
    #bwalk_motion.execute(iter=10,speed=1.1)
    motion1.execute(iter = 1, speed = 1.2)
    #bwalk.execute(iter=5,speed=1.1)
