...
body = {"bhand":[1,2,3,4,5,6],"lhand":[2,4,6],"rhand":[1,3,5],"lleg":[10,12,14,15,16,17,18],"rleg":[9,11,13,15,16,17,18],"torso":range(1,7),"bottom":range(8,19),"body":range(1,21),"shift":[17,9,18,10],"leg_right":[9,11,13,15],"leg_left":[10,12,14,16],}
